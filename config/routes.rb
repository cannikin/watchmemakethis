Watchmemakethis::Application.routes.draw do
  ...
  controller :build do
    ...
    get     '/:site_path/:build_path'         => :show,           :as => :build,          :build_path => /[\w\.-]+/
    post    '/:site_path/:build_path/upload'  => :upload,         :as => :build_upload,   :build_path => /[\w\.-]+/
    delete  '/:site_path/:build_path/:id'     => :destroy_image,  :as => :destroy_image,  :build_path => /[\w\.-]+/
  end
